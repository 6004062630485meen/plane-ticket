...
<div id="t1" class="w3-container">
  <h2><div align="center">ตรวจสอบสถานะการจอง</div></h2><br>
<?php
  require('connect.php');
...
<table class="w3-table-all, w3-table-all w3-card-4">
  <thead>
    <tr class="w3-red">
      ...
      <th width="100"> <div align="center">ผู้จอง</div></th>
      <th width="30"> <div align="center">BasketNo.</div></th>
      <th width="150"> <div align="center">วันจอง</div></th>
      <th width="150"> <div align="center">วันครบกำหนด</div></th>
      <th width="150"> <div align="center">วันที่ชำระเงิน</div></th>
...
?>
  <tr>
    ...
    <td><div align="center"><?php echo $objResult["refStatus"];?></div></td>
    <td><div align="center"><a href="edit.php?refNo=<?php echo $objResult["refNo"];?>">Edit</a></div></td>
  </tr>
<?php
$i++;
}
