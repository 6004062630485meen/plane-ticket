    ...
    <section class="ftco-section contact-section bg-light">
      <div class="container">
        <div class="row d-flex mb-5 contact-info">
          ...
          <div class="col-md-4 d-flex">
            <div class="info bg-white p-4">
              <p><span>Name:</span> <td><input class = "form-control" type="text" name="MemberName" placeholder="Name"></td></p>
            </div>
          </div>
          <div class="col-md-4 d-flex">
            <div class="info bg-white p-4">
              <p><span>Surname:</span> <td><input class = "form-control" type="text" name="MemberSur" placeholder="Surname"></td></p>
            </div>
          </div>
          <div class="col-md-4 d-flex">
            <div class="info bg-white p-4">
              <p><span>Password</span> <td><input class = "form-control" type="Password" name="MemberPass" placeholder="Password"></td></p>
            </div>
          </div>
